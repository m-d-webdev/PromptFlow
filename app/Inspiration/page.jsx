  ...
  return (
    <div className=" flex flex-col items-center w-full">
      <div className="max-w-[2000] w-full">
        ...
        <div className="w-full  pt-40  pb-20 justify-center min-h-[100vh] flex flex-col items-center">
          <h1 className="text-4xl font-extrabold max-w-[700] text-center tracking-tighter" >Discover over 1.2M AI-generated creations shared by our community</h1>
          <div className="flex relative mt-30 h-[300] md:h-[400] gap-3  items-center">

            <p className="absolute  -left-2 -top-5 font-medium text-sm tracking-tight  max-w-[120]">
              <Fan className="text-chart-1 absolute w-4 h-4 -top-6 -left-4" />
              Powered by AI, inspired by you.
            </p>
            <div
              className="absolute   bg-background border-l border-chart-4 rounded-md border-b right-[-60] opacity-70 -top-15">
