    ...
    return (
        <>
            <div
                ...
                <button onClick={() => setisMonthly(true)} className={`z-[2] ${isMonthly ? "text-white" : ""} duration-200 cursor-pointer `} >Monthly</button>
                <button onClick={() => setisMonthly(false)} className={`z-[2] ${isMonthly ? "" : "text-white"} duration-200 cursor-pointer `}>Annual ( Save {reductionPerYear}% )</button>
                <div className={`absolute bg-chart-1 h-[90%]  rounded-full  ${isMonthly ? "left-1 w-[83]" : "left-[88] w-[165]"} duration-200 `}></div>
            </div>
            <div className="flex gap-10 items-center w-full flex-col md:flex-row max-w-[500] md:max-w-[1000] mt-20">
                ...
                <div
                    ...
                    className={` border bg-background ${selected == 1 ? "border-chart-1/50 -translate-y-5 opacity-100" : "translate-y-0 opacity-70"}  duration-200 w-full md:w-[300] p-4 rounded-md`}>
                ...
                <div
                    ...
                    className={`border relative overflow-hidden bg-background ${selected == 2 ? "border-chart-1/50 -translate-y-5 opacity-100" : "translate-y-0 opacity-70"}  duration-200 w-full md:w-[300] p-4 rounded-md`}>
                ...
                <div
                    ...
                    className={`border bg-background ${selected == 3 ? "border-chart-1/50 -translate-y-5 opacity-100" : "translate-y-0 opacity-70"}  duration-200 w-full md:w-[300] p-4 rounded-md`}>
