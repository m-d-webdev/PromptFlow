        ...
        <div className="flex gap-3 min-h-[90vh]  justify-center mt-14 w-full flex-col">
            ...
            <div className=" ml-5 mt-2">
                ...
                <div className="flex gap-3 flex-wrap items-center">
                    ...
                    <a target="_blank" className="flex gap-3 items-center p2 bg-background rounded-md border border-foreground/10 opacity-70 hover:opacity-100  duration-200 font-semibold  tracking-tighter text-base  p-3 px-4 md:min-w-[200] " href="https://openai.com/dall-e">
                        <img className="w-[30] h-[30] object-cover" src="/logos/CHATGPT PNG.jpeg" alt="" />
                        DALL·E
                    </a>
                    <a target="_blank" className="flex gap-3 items-center p2 bg-background rounded-md border border-foreground/10 opacity-70 hover:opacity-100  duration-200 font-semibold  tracking-tighter text-base  p-3 px-4 md:min-w-[200] " href="https://stability.ai">
            ...
            <div className=" ml-5 mt-5">
                ...
                <div className="flex gap-3 flex-wrap items-center">
                    ...
                    <a target="_blank" className="flex gap-3 items-center p2 bg-background rounded-md border border-foreground/10 opacity-70 hover:opacity-100  duration-200 font-semibold  tracking-tighter text-base  p-3 px-4 md:min-w-[200] " href="https://pika.art">
            ...
            <div className=" ml-5 mt-5">
                ...
                <div className="flex gap-3 flex-wrap items-center">
                    ...
                    <a target="_blank" className="flex gap-3 items-center p2 bg-background rounded-md border border-foreground/10 opacity-70 hover:opacity-100  duration-200 font-semibold  tracking-tighter text-base  p-3 px-4 md:min-w-[200] " href="https://udio.com">
            ...
            <div className=" ml-5 mt-5">
                ...
                <div className="flex gap-3 flex-wrap items-center">
                    ...
                    <a target="_blank" className="flex gap-3 items-center p2 bg-background rounded-md border border-foreground/10 opacity-70 hover:opacity-100  duration-200 font-semibold  tracking-tighter text-base  p-3 px-4 md:min-w-[200] " href="https://chat.openai.com/">
                        <img className="w-[30] h-[30] object-cover" src="/logos/CHATGPT PNG.jpeg" alt="" />
                        ChatGPT
                    </a>
                    <a target="_blank" className="flex gap-3 items-center p2 bg-background rounded-md border border-foreground/10 opacity-70 hover:opacity-100  duration-200 font-semibold  tracking-tighter text-base  p-3 px-4 md:min-w-[200] " href="https://gemini.google.com">
                    ...
                    <a target="_blank" className="flex gap-3 items-center p2 bg-background rounded-md border border-foreground/10 opacity-70 hover:opacity-100  duration-200 font-semibold  tracking-tighter text-base  p-3 px-4 md:min-w-[200] " href="https://perplexity.ai">
