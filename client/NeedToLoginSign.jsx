...

                {
                    ...
                    <Model  >
                        <motion.div
                            ...
                            className="bg-background  p-4 rounded-md md:w-[380] "
                        >
                            ...
                            <p className=" mt-3 px-1 font-medium tracking-tight">You need to be logged in to perform this action. Please log in to continue.</p>
                            <Button onClick={() => setuserAcceptLoggin(true)} className={"w-full tracking-tight mt-6 gap-7"} variant={"outline"} >
                                {
                                    isLoadingUser
